function DisplayMatchingSet(menShortlist,womenShortlist,stableMatchingSet,parentLinks,filename)
...
for i = 1: size(stableMatchingSet,1)
    ...
    [fm,sm,sw] = MatchingCost(menShortlist,womenShortlist,stableMatching);    
